...
<head>
   <title>Tradeoff Analytics For Stocks</title>
   <meta charset="utf-8">
       ...
       <div class="row">
           <div class="col-lg-12">
               <div class="row top-nav">
                   <div class="col-lg-12">
<center>                       <h3 class="heading left"><span>STOCK ANALYSIS</span>: using IBM Watson</h3>
        </center>           </div>
               </div>
               <div style="padding-bottom:0px;" class="row header">
                   ...
                   <div class="col-lg-6 col-xs-6">
                       <h2></h2>
                 <center>      <p>Stock Analysis is used to analyse the available stock data using Tradeoff Analytics Watson service to make a Better Decision</p>
      </center>               </div>
					...
					<div class="col-lg-6 col-md-6 col-xs-6">
						<label for="problems" class="control-label">Select a
							...
							id="problems" class="problems form-control"><option
								value="phones.json">Accident & Health Insurance</option>
							<option value="finance.json">Advertising Agencies</option>
							<option value="treatments-selection.json">Agricultural Chemicals</option>
							<option value="drug-candidates.json">Aerospace/Defense - Major Diversified</option></select>
					</div>
